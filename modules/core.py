...
class Module(api.Module):
    ...
    def privmsg(self, nick, data, channel):
        if '#' not in channel and '&' not in channel: # if message is a pm, this time with local channels not being ignored, too. This ACTUALLY should be parsed from numeric 005!
            channel = nick
        ldata = data.lower()
        ...
        # Version ping
            ...
            self.notice(nick, '\x01VERSION bbot-hydra Version %s\x01'%BBot.VERSION)
    ...
    def version(self, nick, channel, param = None):
        ...
        self.msg(channel, 'bbot-hydra Version %s' % BBot.VERSION)
